...
PARAMETER {
	...
	v 		(mV)
	cai  		(mM)
	caix = 4 :modified in the main hoc file from 1
									
	Ra   = 0.05 (/ms):  max act rate, modified in apical_simulation.hoc from 0.01
	Rb   = 0.1 (/ms): max deact rate, modified in apical_simulation.hoc from 0.02 
