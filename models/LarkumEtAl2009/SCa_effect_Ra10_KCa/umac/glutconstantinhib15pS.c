...
#define cah cah_glutconstantinhib15pS
 double cah = 10;
#define gama gama_glutconstantinhib15pS
 double gama = 0.08;
#define n n_glutconstantinhib15pS
 double n = 0.3;
#define tauh tauh_glutconstantinhib15pS
 double tauh = 1000;
#define tau_ampa tau_ampa_glutconstantinhib15pS
 double tau_ampa = 2;
#define tau2 tau2_glutconstantinhib15pS
 double tau2 = 3;
#define tau1 tau1_glutconstantinhib15pS
 double tau1 = 70;
 ...
 "tau1_glutconstantinhib15pS", "ms",
 "gama_glutconstantinhib15pS", "/mV",
 "cah_glutconstantinhib15pS", "/ms",
 "tauh_glutconstantinhib15pS", "/ms",
 "gmax", "nS",
 "e", "mV",
 "e_inh", "mV",
 "A", "nS",
 ...
 "tau1_glutconstantinhib15pS", &tau1_glutconstantinhib15pS,
 "tau2_glutconstantinhib15pS", &tau2_glutconstantinhib15pS,
 "tau_ampa_glutconstantinhib15pS", &tau_ampa_glutconstantinhib15pS,
 "n_glutconstantinhib15pS", &n_glutconstantinhib15pS,
 "gama_glutconstantinhib15pS", &gama_glutconstantinhib15pS,
 "cah_glutconstantinhib15pS", &cah_glutconstantinhib15pS,
 "tauh_glutconstantinhib15pS", &tauh_glutconstantinhib15pS,
 0,0
};
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 2;
 	...
 	ivoc_help("help ?1 glutconstantinhib15pS /Users/danielruedt/PhD/simulations/LarkumEtAl2009_template_ratecoding/umac/glutconstantinhib15pS.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 123 in file glutconstantinhib15pS.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
