	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 6);
 	...
 	ivoc_help("help ?1 hh3 /Users/danielruedt/PhD/simulations/LarkumEtAl2009_template_ratecoding/umac/hh3.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("hh3", "cannot be used with CVODE");}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 61 in file hh3.mod:\n\n"); nrn_complain(_p); abort_run(error);}
