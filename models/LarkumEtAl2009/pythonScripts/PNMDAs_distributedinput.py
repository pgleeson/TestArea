...
if numGenerated > 0:
    ...
    ms = 10
    Hz = 0.1
    syns = 160 #will run in steps of 10 synpases
    
    prefix = "dist" #string that will be added to the name of the simulations to identify the simulation set    
