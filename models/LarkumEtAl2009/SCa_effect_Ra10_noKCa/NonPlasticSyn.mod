COMMENT
   ...
   **************************************************
   ...
   NonPlasticSyn (Type: Synaptic mechanism, Model: Template based ChannelML file)

   with parameters: 
   /channelml/@units = Physiological Units 
   /channelml/notes = ChannelML file describing a single synaptic mechanism 
   /channelml/synapse_type/@name = NonPlasticSyn 
   ...
   /channelml/synapse_type/doub_exp_syn/@max_conductance = 0.3E-6 
   /channelml/synapse_type/doub_exp_syn/@rise_time = .3 
   /channelml/synapse_type/doub_exp_syn/@decay_time = 3 
   /channelml/synapse_type/doub_exp_syn/@reversal_potential = 0 

// File from which this was generated: /Users/danielruedt/nC_projects/LarkumEtAl2009_local/cellMechanisms/NonPlasticSyn/DoubExpSyn.xml

// XSL file with mapping to simulator: /Users/danielruedt/nC_projects/LarkumEtAl2009_local/cellMechanisms/NonPlasticSyn/ChannelML_v1.8.1_NEURONmod.xsl
