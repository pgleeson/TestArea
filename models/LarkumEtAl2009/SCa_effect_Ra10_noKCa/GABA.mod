COMMENT
   ...
   **************************************************
   ...
   GABA (Type: Synaptic mechanism, Model: ChannelML based process)

   with parameters: 
   /channelml/@units = Physiological Units 
   /channelml/notes = ChannelML file describing a single synaptic mechanism 
   /channelml/synapse_type/@name = GABA 
   ...
   /channelml/synapse_type/doub_exp_syn/@max_conductance = 0.5E-6 
   /channelml/synapse_type/doub_exp_syn/@rise_time = 0.3 
   /channelml/synapse_type/doub_exp_syn/@decay_time = 10 
   /channelml/synapse_type/doub_exp_syn/@reversal_potential = -75 

// File from which this was generated: /Users/danielruedt/nC_projects/LarkumEtAl2009_local/cellMechanisms/GABA/DoubExpSyn.xml

// XSL file with mapping to simulator: /Users/danielruedt/nC_projects/LarkumEtAl2009_local/cellMechanisms/GABA/ChannelML_v1.8.1_NEURONmod.xsl
