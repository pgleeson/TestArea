...
// File from which this was generated: /Users/danielruedt/nC_projects/LarkumEtAl2009_local/cellMechanisms/FastSynInput/DoubExpSyn.xml

// XSL file with mapping to simulator: /Users/danielruedt/nC_projects/LarkumEtAl2009_local/cellMechanisms/FastSynInput/ChannelML_v1.8.1_NEURONmod.xsl
...
PARAMETER {
    gmax = 0.1
    tau_rise = 0.24 (ms) <1e-9,1e9>
    tau_decay = 0.26 (ms) <1e-9,1e9>
    e = 40  (mV)
