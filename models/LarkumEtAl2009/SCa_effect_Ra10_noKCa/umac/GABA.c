	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 GABA /Users/danielruedt/PhD/simulations/LarkumEtAl2009_template_ratecoding/umac/GABA.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Channel: GABA";
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 112 in file GABA.mod:\n    SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
