...
#define gama gama_noCaglutamate
 double gama = 0.08;
#define n n_noCaglutamate
 double n = 0.3;
#define tau_ampa tau_ampa_noCaglutamate
 double tau_ampa = 1;
#define tau2 tau2_noCaglutamate
 double tau2 = 3;
#define tau1 tau1_noCaglutamate
 double tau1 = 70;
 ...
 "tau1_noCaglutamate", "ms",
 "tau_ampa_noCaglutamate", "ms",
 "gama_noCaglutamate", "/mV",
 "gmax", "nS",
 "e", "mV",
 "A", "nS",
 "B", "nS",
 ...
 "tau1_noCaglutamate", &tau1_noCaglutamate,
 "tau2_noCaglutamate", &tau2_noCaglutamate,
 "tau_ampa_noCaglutamate", &tau_ampa_noCaglutamate,
 "n_noCaglutamate", &n_noCaglutamate,
 "gama_noCaglutamate", &gama_noCaglutamate,
 0,0
};
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 2;
 	...
 	ivoc_help("help ?1 noCaglutamate /Users/danielruedt/PhD/simulations/LarkumEtAl2009_template_ratecoding/umac/noCaglutamate.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 101 in file noCaglutamate.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
