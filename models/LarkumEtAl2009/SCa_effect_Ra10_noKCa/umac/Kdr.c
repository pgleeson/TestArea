	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 5);
 	...
 	ivoc_help("help ?1 Kdr /Users/danielruedt/PhD/simulations/LarkumEtAl2009_template_ratecoding/umac/Kdr.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dn = ( 1.0 - n ) * alf ( _threadargscomma_ v ) - n * bet ( _threadargscomma_ v ) ;
   }
 return _reset;
}
 static int _ode_matsol1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
 Dn = Dn  / (1. - dt*( (( ( - 1.0 ) ))*(alf ( _threadargscomma_ v )) - (1.0)*(bet ( _threadargscomma_ v )) )) ;
}
 /*END CVODE*/
...
double alf ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
   double _lalf;
 double _lva ;
...
double bet ( _p, _ppvar, _thread, _nt, _lv ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; 
	double _lv ;
 {
   double _lbet;
 double _lvb ;
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  ...
  n = n0;
 {
   n = alf ( _threadargscomma_ v ) / ( alf ( _threadargscomma_ v ) + bet ( _threadargscomma_ v ) ) ;
   }
