	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  hoc_register_dparam_size(_mechtype, 1);
 	...
 	ivoc_help("help ?1 hd /Users/danielruedt/PhD/simulations/LarkumEtAl2009_template_ratecoding/umac/h.mod\n");
...
static int  rate (  _lv )  
 ...
 _lqt = pow( q10 , ( ( celsius - 33.0 ) / 10.0 ) ) ;
   ...
   taul = tau * bett ( _threadargscomma_ _lv ) / ( qtl * _lqt * a0t * ( 1.0 + _la ) ) ;
    return 0; }
