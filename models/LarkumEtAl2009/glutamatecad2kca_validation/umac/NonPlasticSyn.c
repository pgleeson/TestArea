...
#define gmax _p[0]
#define tau_rise _p[1]
#define tau_decay _p[2]
#define e _p[3]
#define i _p[4]
#define g _p[5]
#define factor _p[6]
...
#define total total_NonPlasticSyn
 double total = 0;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "tau_decay", 1e-09, 1e+09,
 "tau_rise", 1e-09, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "total_NonPlasticSyn", "uS",
 "tau_rise", "ms",
 "tau_decay", "ms",
 "e", "mV",
 "A", "uS",
 ...
 "total_NonPlasticSyn", &total_NonPlasticSyn,
 0,0
};
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NonPlasticSyn /Users/danielruedt/PhD/simulations/LarkumEtAl2009_template_ratecoding/umac/NonPlasticSyn.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Channel: NonPlasticSyn";
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 112 in file NonPlasticSyn.mod:\n    SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
