...
#define cah cah_AMPA
 double cah = 8;
#define gama gama_AMPA
 double gama = 0.08;
#define n n_AMPA
 double n = 0.3;
#define tauh tauh_AMPA
 double tauh = 1000;
#define tau_ampa tau_ampa_AMPA
 double tau_ampa = 1;
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 2;
 	...
 	ivoc_help("help ?1 AMPA /Users/danielruedt/PhD/simulations/model_validation/glutamate200_dt0.025/umac/AMPA.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 108 in file AMPA.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
