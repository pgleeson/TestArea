...
#define cah cah_glutconstantinhib30pS
 double cah = 10;
#define gama gama_glutconstantinhib30pS
 double gama = 0.08;
#define n n_glutconstantinhib30pS
 double n = 0.3;
#define tauh tauh_glutconstantinhib30pS
 double tauh = 1000;
#define tau_ampa tau_ampa_glutconstantinhib30pS
 double tau_ampa = 2;
#define tau2 tau2_glutconstantinhib30pS
 double tau2 = 3;
#define tau1 tau1_glutconstantinhib30pS
 double tau1 = 70;
 ...
 "tau1_glutconstantinhib30pS", "ms",
 "gama_glutconstantinhib30pS", "/mV",
 "cah_glutconstantinhib30pS", "/ms",
 "tauh_glutconstantinhib30pS", "/ms",
 "gmax", "nS",
 "e", "mV",
 "e_inh", "mV",
 "A", "nS",
 ...
 "tau1_glutconstantinhib30pS", &tau1_glutconstantinhib30pS,
 "tau2_glutconstantinhib30pS", &tau2_glutconstantinhib30pS,
 "tau_ampa_glutconstantinhib30pS", &tau_ampa_glutconstantinhib30pS,
 "n_glutconstantinhib30pS", &n_glutconstantinhib30pS,
 "gama_glutconstantinhib30pS", &gama_glutconstantinhib30pS,
 "cah_glutconstantinhib30pS", &cah_glutconstantinhib30pS,
 "tauh_glutconstantinhib30pS", &tauh_glutconstantinhib30pS,
 0,0
};
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 2;
 	...
 	ivoc_help("help ?1 glutconstantinhib30pS /Users/danielruedt/PhD/simulations/LarkumEtAl2009_template_ratecoding/umac/glutconstantinhib30pS.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   ica = inmda / 10.0 ;
   i_inh = ( 1e-3 ) * ( 0.030 ) * ( v - e_inh ) ;
   i = ( 1e-3 ) * g * ( v - e ) + inmda + i_inh ;
   local_v = v ;
   }
 _current += ica;
 _current += i;
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 123 in file glutconstantinhib30pS.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
