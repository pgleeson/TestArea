...
#define cah cah_glutnoinact
 double cah = 8;
#define gama gama_glutnoinact
 double gama = 0.08;
#define n n_glutnoinact
 double n = 0.3;
#define tauh tauh_glutnoinact
 double tauh = 1000;
#define tau_ampa tau_ampa_glutnoinact
 double tau_ampa = 1;
#define tau2 tau2_glutnoinact
 double tau2 = 3;
#define tau1 tau1_glutnoinact
 double tau1 = 70;
 ...
 "tau1_glutnoinact", &tau1_glutnoinact,
 "tau2_glutnoinact", &tau2_glutnoinact,
 "tau_ampa_glutnoinact", &tau_ampa_glutnoinact,
 "n_glutnoinact", &n_glutnoinact,
 "gama_glutnoinact", &gama_glutnoinact,
 "cah_glutnoinact", &cah_glutnoinact,
 "tauh_glutnoinact", &tauh_glutnoinact,
 0,0
};
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 2;
 	...
 	ivoc_help("help ?1 glutnoinact /Users/danielruedt/PhD/simulations/segmentation_effects/glutamate200_dt0.025_original_noSCa_KCa_noCaIon/umac/glutnoinact.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 108 in file glutnoinact.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
