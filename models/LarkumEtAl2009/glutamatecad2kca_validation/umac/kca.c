	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 kca /Users/danielruedt/PhD/simulations/LarkumEtAl2009_template_ratecoding/umac/kca.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("kca", "cannot be used with CVODE");}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 74 in file kca.mod:\n        SOLVE states\n"); nrn_complain(_p); abort_run(error);}
