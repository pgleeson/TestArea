...
#define cah cah_focalstim
 double cah = 8;
#define gama gama_focalstim
 double gama = 0.08;
#define n n_focalstim
 double n = 0.3;
#define tauh tauh_focalstim
 double tauh = 1000;
#define tau_ampa tau_ampa_focalstim
 double tau_ampa = 1;
#define tau2 tau2_focalstim
 double tau2 = 3;
#define tau1 tau1_focalstim
 double tau1 = 70;
 ...
 "tau1_focalstim", &tau1_focalstim,
 "tau2_focalstim", &tau2_focalstim,
 "tau_ampa_focalstim", &tau_ampa_focalstim,
 "n_focalstim", &n_focalstim,
 "gama_focalstim", &gama_focalstim,
 "cah_focalstim", &cah_focalstim,
 "tauh_focalstim", &tauh_focalstim,
 0,0
};
	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 2;
 	...
 	ivoc_help("help ?1 focalstim /Users/danielruedt/PhD/simulations/segmentation_effects/glutamate200_dt0.025_original/umac/focalstim.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  state();
 if(error){fprintf(stderr,"at line 108 in file focalstim.mod:\n	\n"); nrn_complain(_p); abort_run(error);}
