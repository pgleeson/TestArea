...
PARAMETER { 
	...
	Aalpha_h = 6.0e-5(/ms) : the original value was 6.0e-5(/ms), Dan changed it to fit Jason's traces
	Kalpha_h = -12.5(mV) : R=
	V0alpha_h = -46 (mV)
 
	Abeta_h = 1.1e-3(/ms) : the original value was 1.1e-3(/ms), Dan changed it to fit Jason's traces
	Kbeta_h = 12.4(mV)
	...
	celsius = 37 (degC) 
	Q10 = 3 :
	TC=5 : the original value was 5, Dan changed it to fit Jason's traces
} 
